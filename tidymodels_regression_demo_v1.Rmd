...
tmp_df <- data.frame(v0.3=vmod_v0.3$model$object$fit$fit$object$fit$residuals,
                      v0.2=vmod_v0.2$model$object$fit$fit$object$fit$residuals
#                      v0.1=vmod_v0.1$model$object$fit$fit$object$fit$residuals,
#                      v0=vmod_v0$model$object$fit$fit$object$fit$residuals,
                      )
 
  tmp_df|> pivot_longer(cols=c('v0.3','v0.2'),names_to = 'name') |>
